/**
 * FacultyModal.jsx
 * Modal component for displaying detailed faculty information.
 */
...
import { FacultyMember, TimeSlot } from '../../types'
...
const FacultyModal: React.FC<FacultyModalProps> = ({ faculty, onClose }) => {
  ...
  const generateTableRow = (hoursPerDay: TimeSlot[][] = []) => {
  ...
  const generateCourseTabs = (scheduleArray: any[]) => {
    return (
